...
class TrackList {
    ...
    init {
        ...
        tracksList.add(Track("Yesterday (Remastered 2009)", "The Beatles", "2:55", ""))
        tracksList.add(Track("Here Comes The Sun (Remastered 2009)", "The Beatles", "4:01", ""))
        tracksList.add(Track("No Reply", "The Beatles", "5:12", ""))
        tracksList.add(Track("Let It Be", "The Beatles", "6:01", ""))
        tracksList.add(Track("Girl", "The Beatles", "4:11", ""))
        tracksList.add(Track("Michelle", "The Beatles", "3:01", ""))
        tracksList.add(Track("Eleanor Rigby", "The Beatles", "6:12", ""))
        tracksList.add(Track("Come Together", "The Beatles", "4:09", ""))
